...
run_iteration() {
    ...
    sleep 60
    python generation/gen_hf.py --ports 8005 8002 8003 8004 --eos_ids 128009 --tokenizer $initial_model --dataset_name_or_path $jsonl_input --output_dir $json_output --K 8 --temperature 1.0
